                   ...
                   .withRunnableContext(
                       WorkerAnonymEmitter.builder()
                                          ...
                                          .withProps(Props.builder()
                                                          .withConnect(asList(connectAddresses))
                                                          .build())
                   ...
                   .withRunnableContext(
                       LruRouter.builder()
                                ...
                                .withFrontendProps(Props.builder()
                                                        .withBind(frontendAddress)
                                                        .build())
                                .withBackendProps(Props.builder()
                                                       .withBind(backendAddress)
                                                       .build())
                                .build()
                   )
                   .build()
    ...
    BlockingClient target =
        BlockingClient.builder()
                      .withChannelBuilder(ZmqChannel.DEALER(ctx)
                                                    .withProps(Props.builder()
                                                                    .withConnect(asList(connAddresses))
                                                                    .build()))
                      .build();
    with(target);
    return target;
