        ...
        ZmqRunnable.builder()
                   .withRunnableContext(
                       Chat.builder()
                           .withCtx(ctx)
                           .withPollTimeout(100)
                           .withFrontendPubProps(Props.builder().withBind(frontendPub).build())
                           .withClusterPubProps(Props.builder().withBind(clusterPub).build())
                           .withFrontendSubProps(Props.builder().withBind(frontendSub).build())
                           .withClusterSubProps(Props.builder().withConnect(clusterPubConnAddr).build())
                           .build()
                   )
                   .build()
    );
